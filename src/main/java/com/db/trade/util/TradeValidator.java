...
public class TradeValidator {
	...
	public void tradePreValidation(TradeDto tradeRequest) {
		...
		if (!validationErrors.isEmpty()) {
			...
			throw new BusinessException(ExceptionConstants.ERROR_104, new RuntimeException("Trade Validations Failed"));
		}
	}
	...
	private void validateMaturityDate(LocalDate maturityDate, Map<ExceptionConstants, String> validationErrors, String tradeId) {
		if (maturityDate.isBefore(LocalDate.now())) {
			...
			validationErrors.put(ExceptionConstants.ERROR_103, ExceptionConstants.ERROR_103.getErrorMessage());
		}
	...
	private void validateTradeVersion(Integer requestedTradeVersion,
		...
		if (requestedTradeVersion < existingtradeDetail.getTradeVersion()) {
			...
			validationErrors.put(ExceptionConstants.ERROR_102, ExceptionConstants.ERROR_102.getErrorMessage());
		}
		}
	}
